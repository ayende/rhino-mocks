...
namespace Rhino.Mocks.Tests.Expectations
{
	...
	public class ArgsEqualTests : AbstractExpectationTests
	{
		...
		{
			ArgsEqualExpectation expectation = new ArgsEqualExpectation(m, new object[0]);
		...
		{
			IExpectation expectation = new ArgsEqualExpectation(method, new object[] {1, "43", 5.2f});
		...
		public void ArgsEqualWhenValueTypeArrayArgsMatch()
		{
			...
			IExpectation expectation = new ArgsEqualExpectation(method, new object[] { new ushort[] { 123, 456 } });
		...
		{
			IExpectation expectation = new ArgsEqualExpectation(method, new object[] {1, "43", 5.2f});
			IExpectation other = new AnyArgsExpectation(method);
		...
		{
			object[] args = new object[] {1, "43", 5.2f};
			ArgsEqualExpectation expectation = new ArgsEqualExpectation(method, args);
		...
		{
			IExpectation expectation = new ArgsEqualExpectation(method, new object[] {1, null, 5.2f});
		...
		public void ArgsEqualWithArrayReferenceEqual()
		{
			...
			IExpectation expectation = new ArgsEqualExpectation(method, new object[] {1, arr});
		...
		public void ArgsEqualWithArrayContentEqual()
		{
			...
			IExpectation expectation = new ArgsEqualExpectation(method, new object[] {1, arr2});
		...
		public void ArgsEqualWithArrayContentDifferent()
		{
			...
			IExpectation expectation = new ArgsEqualExpectation(method, new object[] {1, arr1, 3});
		...
		{
			ArgsEqualExpectation expectation =new ArgsEqualExpectation(method, new object[]{1,null, 3.3f});
		...
		public void ArgsEqualWithArrayContentLengthDifferent()
		{
			...
			IExpectation expectation = new ArgsEqualExpectation(method, new object[] {1, arr1});
		...
		public void ArgsEqualWithStringArray()
		{
			...
			IExpectation expectation = new ArgsEqualExpectation(method, str1);
